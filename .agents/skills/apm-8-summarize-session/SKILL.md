---
name: apm-8-summarize-session
description: Summarize and optionally archive an APM session.
user-invocable: true
---

# APM 1.0.2 - Summarize Session Command
